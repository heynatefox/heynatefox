        ...
        <div className="about-traits">
          <div className="trait">
            ...
            <div className="trait-content">
              <div className="trait-title">Leverage over tactics</div>
              <div className="trait-desc">Always asking: what&apos;s the one change that unlocks everything else? Not what&apos;s the next campaign to run.</div>
            </div>
          </div>
          <div className="trait">
            <div className="trait-icon">🎯</div>
          ...
          <div className="trait">
            <div className="trait-icon">🔧</div>
            <div className="trait-content">
              <div className="trait-title">Actually technical</div>
              <div className="trait-desc">I build with Claude, ChatGPT, and v0.dev. Shipped products, designed AI-driven workflows. Not a talking point.</div>
            </div>
          </div>
          <div className="trait">
            <div className="trait-icon">💡</div>
            <div className="trait-content">
              <div className="trait-title">Narrative + mechanics</div>
              <div className="trait-desc">Narrative without substance collapses. Substance without narrative doesn&apos;t spread. I design both simultaneously.</div>
            </div>
          </div>
        </div>
      </div>
